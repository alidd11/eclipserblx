...
import { 
  ...
  UserCheck, Link2, Code, Globe, Scale, Rss, FileCode, Twitter, ShieldCheck, Zap
} from 'lucide-react';
...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    icon: Wallet,
    items: [
      { title: 'Revenue', icon: TrendingUp, href: '/admin/revenue', permissions: ['view_income'] },
      { title: 'Platform Ledger', icon: DollarSign, href: '/admin/platform-ledger', permissions: ['view_income'] },
      { title: 'Payouts', icon: Wallet, href: '/admin/payouts', permissions: ['view_seller_payouts'] },
      { title: 'Refunds & Disputes', icon: RotateCcw, href: '/admin/disputes-refunds', permissions: ['manage_orders'], dividerAfter: true },
      { title: 'Affiliates', icon: Gift, href: '/admin/affiliate-hub', permissions: ['view_affiliates'] },
    ],
  },
  {
    id: 'communications',
  ...
  },
  {
    ...
    icon: Store,
    items: [
      { title: 'Store Applications', icon: UserCheck, href: '/admin/store-applications', permissions: ['view_store_applications', 'review_store_applications'] },
