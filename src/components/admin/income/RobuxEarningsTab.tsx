...
export function RobuxEarningsTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-[1fr,280px]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Daily Robux earnings (after tax)</CardDescription>
          </CardHeader>
          <CardContent>
            <RevolutLineChart
              data={trendData}
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><Gamepad2 className="h-5 w-5" />Recent Transactions</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="border-dashed">
        <CardHeader>
          ...
          <CardDescription>Add the tracking script to your Roblox game to automatically log purchases</CardDescription>
        </CardHeader>
