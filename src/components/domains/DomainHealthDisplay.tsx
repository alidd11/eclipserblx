...
const ERROR_INFO: Record<string, {
  ...
  '1000': {
    ...
    steps: [
      ...
      'Or delete the CNAME and add an A record → 185.158.133.1 (DNS-only)',
      'Or move your DNS to a non-Cloudflare provider',
      'If none work, pause Cloudflare entirely (Overview → Advanced → Pause)',
    ],
    icon: 'dns',
  },
  '1000_non_cf': {
