...
export function UpgradeBanner({ currentServers = 0, maxServers = 2, variant = 'full' }: UpgradeBannerProps) {
 ...
 return (
 <div className="border border-border rounded-xl overflow-hidden border-blue-500/20 bg-gradient-to-br from-blue-500/5 via-cyan-500/5 to-transparent overflow-hidden">
