...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border">
      {/* Combined Banner + Navigation */}
      <div 
        className="relative w-full"
        style={{
          backgroundImage: `url(${eclipseBanner})`,
        ...
        <div className="relative container mx-auto px-4">
          <div className="flex h-12 sm:h-14 md:h-16 items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-2">
              <EclipseLogo size="sm" />
              <span className="font-display text-lg font-bold text-white drop-shadow-lg hidden sm:block">
                {SITE_NAME}
              </span>
            </Link>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              >
                <Button variant="ghost" size="icon" className="h-8 w-8 sm:h-9 sm:w-9 text-white/80 hover:text-white hover:bg-white/10">
                  <svg
              ...
              <Link to="/cart">
                <Button variant="ghost" size="icon" className="relative h-8 w-8 sm:h-9 sm:w-9 text-white/80 hover:text-white hover:bg-white/10">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="md:hidden h-8 w-8 sm:h-9 sm:w-9 text-white/80 hover:text-white hover:bg-white/10"
      ...
      <div
        className={cn(
          'md:hidden transition-all duration-300 bg-background',
      ...
      >
        <nav className="flex flex-col gap-2 container mx-auto px-4">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              to={link.href}
