...
import { Bot, ExternalLink, CheckCircle, XCircle, Loader2, Terminal } from 'lucide-react';
  ...
  return (
    <Card className="border-[#5865F2]/30">
      <CardHeader>
        ...
        <CardDescription>
          Add the Eclipse Portal Bot to your Discord server so customers can download products, link accounts, and more — directly from your community
        </CardDescription>
      </CardHeader>
        ...
        {isConnected ? (
          ...
          <div className="flex flex-col gap-3">
            <div className="p-3 bg-muted/50 rounded-lg text-sm text-muted-foreground">
              ...
              They'll be able to download products, link accounts, check purchases, and claim roles — all without leaving Discord.
            </div>
            <Button
