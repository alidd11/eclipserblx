...
const AVAILABLE_COMMANDS = [
 ...
 { name: '/daily', description: 'Claim daily XP rewards with streak bonuses' },
 { name: '/leaderboard', description: 'View the Eclipse XP leaderboard' },
 { name: '/balance', description: 'View credits and XP in one place' },
...
export function AddPortalBotCard() {
 ...
 <div className="border border-border rounded-xl overflow-hidden border-[#5865F2]/30">
 <CollapsibleTrigger asChild>
 <div className="px-4 py-3 border-b border-border bg-muted/30 cursor-pointer select-none">
