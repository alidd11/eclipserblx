 ...
 <div className="border border-border rounded-xl overflow-hidden cursor-pointer hover:bg-muted/50 active:bg-muted/70 transition-colors touch-manipulation">
