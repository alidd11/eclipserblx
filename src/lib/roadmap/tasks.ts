...
export const ROADMAP_PHASES: RoadmapPhase[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { key: 'pay.subscriptions', title: 'Seller Pro customer-portal', description: 'customer-portal Stripe billing portal for Seller Pro', probe: 'fileExists:supabase/functions/customer-portal/index.ts', seed: 'done' },
