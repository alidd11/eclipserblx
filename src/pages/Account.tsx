      ...
      <div className="container py-8 space-y-6 max-w-4xl">
        ...
        <Card className="bg-card border-border">
          <CardContent className="py-4 px-4 sm:px-6">
            ...
            {/* Discord Section - Integrated into profile card */}
            <div className="mt-4 pt-4 border-t border-border">
              {profile?.discord_id ? (
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/30 border border-border/50">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium">Link Discord</p>
                    <p className="text-xs text-muted-foreground">Connect for Eclipse+ role sync</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => handleTabChange('profile')}
                    className="border-[#5865F2]/50 text-[#5865F2] hover:bg-[#5865F2]/10 shrink-0"
                  >
                ...
                {!profile?.discord_id && (
                  <div className="pt-4 border-t border-border">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <p className="text-sm font-medium">Link Discord Account</p>
                    </div>
