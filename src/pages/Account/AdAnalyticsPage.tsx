  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-4 md:overflow-visible">
        <Card className="bg-card border-border min-w-[140px] flex-shrink-0 md:min-w-0">
        ...
        <Card className="bg-card border-border min-w-[140px] flex-shrink-0 md:min-w-0">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-xs font-medium text-muted-foreground">Posted Ads</CardTitle>
        ...
        <Card className="bg-card border-border min-w-[140px] flex-shrink-0 md:min-w-0">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-xs font-medium text-muted-foreground">Avg. Clicks/Ad</CardTitle>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-5">
        ...
        <TabsContent value="overview" className="space-y-5">
          <Card className="bg-card border-border">
            <CardHeader>
              ...
              <CardDescription className="text-xs">Daily click activity across all your advertisements</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="breakdown" className="space-y-5">
          <div className="grid gap-5 md:grid-cols-2">
            <Card className="bg-card border-border">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base"><Monitor className="h-4 w-4 text-primary" />Device Breakdown</CardTitle>
                <CardDescription className="text-xs">Where your clicks are coming from</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-card border-border">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base"><ArrowUpRight className="h-4 w-4 text-primary" />Traffic Sources</CardTitle>
                <CardDescription className="text-xs">Top referrers to your ads</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="top-ads" className="space-y-5">
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base"><Megaphone className="h-4 w-4 text-primary" />Top Performing Ads</CardTitle>
              <CardDescription className="text-xs">Your best performing ads by click count</CardDescription>
            </CardHeader>
            <CardContent>
