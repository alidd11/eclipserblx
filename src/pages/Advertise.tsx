...
export default function Advertise() {
 ...
 <div className={cn("border border-border rounded-xl overflow-hidden", "border-2", tierColors[subscription.tier || 'basic'])}>
 ...
 <div className="border border-border rounded-xl overflow-hidden bg-yellow-500/10 border-yellow-500/30">
 <div className="p-4 pt-6">
 <div className="flex items-center gap-3">
 ...
 <div>
 <h3 className="font-semibold text-sm">Create Your Advertisement</h3>
 <p className="text-sm text-muted-foreground">Fill out the form below to post your Discord advertisement</p>
 </div>
 {lastAd && (
