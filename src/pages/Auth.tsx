      ...
      <div className="min-h-screen flex items-center justify-center p-4 pt-[max(1.5rem,env(safe-area-inset-top))] pb-6 sm:py-10 relative">
        <div className="w-full max-w-[420px] space-y-4">
          ...
          {mode === 'forgot' ? (
            ...
            <form onSubmit={handleVerifyOtp} className="rounded-xl border border-border bg-card p-5 space-y-4">
              <div className="flex justify-center">
                <div className="h-16 w-16 rounded-full bg-primary/10 flex items-center justify-center">
                  <Mail className="h-8 w-8 text-primary" />
                </div>
            ...
            <form onSubmit={handleSubmit} className="rounded-xl border border-border bg-card p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button
                  type="button"
                  variant="outline"
                  className="bg-[#5865F2] hover:bg-[#4752C4] text-white border-0 text-xs h-10"
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="bg-[#E2231A] hover:bg-[#C01E17] text-white border-0 text-xs h-10"
                  disabled={socialLoading || loading}
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="bg-black hover:bg-black/90 text-white border-0 text-xs h-10"
                  disabled={socialLoading || loading}
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 text-xs h-10"
                  disabled={socialLoading || loading}
