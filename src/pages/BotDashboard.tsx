...
export default function BotDashboard() {
  ...
  const { data: purchasedBots, isLoading: loadingInstallations } = useQuery({
  ...
  const installations: BotInstallation[] = (purchasedBots || []).map((bot) => ({
    id: bot.id,
    ...
    <MainLayout>
      <div className="container py-8 max-w-4xl">
        <div className="space-y-2 mb-8">
          ...
          <p className="text-muted-foreground">View your installed bots and manage them</p>
        </div>
              ...
              {installations.map((install) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground truncate">{install.product_name}</p>
                  </div>
            ...
            {selectedInstallation ? (
              <>
                ...
                <div className="border border-border rounded-xl overflow-hidden">
                  <div className="px-4 py-3 border-b border-border bg-muted/30">
                    <h3 className="font-semibold text-sm text-lg">Installation Details</h3>
                  </div>
                ...
                <div className="border border-border rounded-xl overflow-hidden border-primary/20 bg-primary/5">
                  <div className="p-4 pt-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                      ...
                      <Button asChild className="gradient-button border-0 shrink-0">
                        <a
              ...
              <div className="border border-border rounded-xl overflow-hidden">
                <div className="p-4 py-12 text-center">
                  <p className="text-muted-foreground">Select a server to view its details</p>
                </div>
              </div>
            )}
          </div>
