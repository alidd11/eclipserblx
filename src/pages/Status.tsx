...
export default function Status() {
 ...
 <div className="px-4 py-3 border-b border-border bg-muted/30">
 <h3 className="font-semibold text-sm text-sm font-medium">Status Legend</h3>
 </div>
 <div className="p-4">
 ...
 <div className="border border-border rounded-xl overflow-hidden bg-muted/30">
 <div className="px-4 py-3 border-b border-border bg-muted/30">
 <h3 className="font-semibold text-sm text-sm font-medium">Response Time Thresholds</h3>
 </div>
 <div className="p-4">
