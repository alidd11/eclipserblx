      ...
      <div className="space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <TabsContent value="overview" className="space-y-4">
            <div className="bg-card border-border">
              <CardHeader className="pb-3">
                <CardTitle className="flex items-center gap-2"><TrendingUp className="h-5 w-5" />Overview</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            {/* Conversion Funnel */}
            <div className="bg-card border-border">
              <CardHeader className="pb-3"><CardTitle className="flex items-center gap-2"><ArrowRight className="h-5 w-5" />Conversion Funnel</CardTitle></CardHeader>
              <CardContent>
                {(() => {
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-3">
              <div className="bg-card border-border">
                <CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-sm"><Eye className="h-4 w-4" />Page Visits</CardTitle></CardHeader>
                <CardContent>
              ...
              <div className="bg-card border-border">
                <CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-sm"><Store className="h-4 w-4" />Seller Events</CardTitle></CardHeader>
                <CardContent>
              ...
              <div className="bg-card border-border">
                <CardHeader className="pb-2"><CardTitle className="flex items-center gap-2 text-sm"><Link2 className="h-4 w-4" />Referral Clicks</CardTitle></CardHeader>
                <CardContent>
            ...
            <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
              <div className="bg-card border-border">
                <CardHeader><CardTitle className="flex items-center gap-2"><TrendingUp className="h-5 w-5" />Downloads (Last {rangeLabel})</CardTitle></CardHeader>
                <CardContent><RevolutAreaChart data={downloadTrend || []} xKey="date" series={[{ dataKey: 'downloads', color: 'hsl(262 100% 71%)', name: 'Downloads', gradientId: 'dlGrad' }]} height={250} /></CardContent>
              </div>
              <div className="bg-card border-border">
                <CardHeader><CardTitle className="flex items-center gap-2"><ShoppingCart className="h-5 w-5" />Orders (Last {rangeLabel})</CardTitle></CardHeader>
                <CardContent><RevolutAreaChart data={orderTrend || []} xKey="date" series={[{ dataKey: 'orders', color: 'hsl(220 95% 59%)', name: 'Orders', gradientId: 'ordGrad' }]} height={250} /></CardContent>
              </div>
            </div>

            <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
              <div className="bg-card border-border">
                <CardHeader><CardTitle className="flex items-center gap-2"><Users className="h-5 w-5" />New Users (Last {rangeLabel})</CardTitle></CardHeader>
                <CardContent><RevolutAreaChart data={userTrend || []} xKey="date" series={[{ dataKey: 'users', color: 'hsl(240 90% 65%)', name: 'Users', gradientId: 'usrGrad' }]} height={250} /></CardContent>
              </div>
              <div className="bg-card border-border">
                <CardHeader><CardTitle className="flex items-center gap-2"><BarChart3 className="h-5 w-5" />Products by Category</CardTitle></CardHeader>
                <CardContent>
            ...
            <div className="bg-card border-border">
              <CardHeader><CardTitle className="flex items-center gap-2"><Download className="h-5 w-5" />Top Downloaded Products</CardTitle></CardHeader>
              <CardContent>
          ...
          <TabsContent value="page-visits" className="space-y-4">
            <div className="bg-card border-border">
              <CardHeader className="pb-3"><CardTitle className="flex items-center gap-2"><Eye className="h-5 w-5" />Visitor Overview</CardTitle></CardHeader>
              <CardContent>
            ...
            <div className="bg-card border-border">
              <CardHeader><CardTitle className="flex items-center gap-2"><TrendingUp className="h-5 w-5" />Visitor Trend (Last {rangeLabel})</CardTitle></CardHeader>
              <CardContent>
            ...
            <div className="grid gap-4 grid-cols-1 lg:grid-cols-3">
              <div className="bg-card border-border">
                <CardHeader><CardTitle className="flex items-center gap-2 text-sm"><Globe className="h-4 w-4" />By Page</CardTitle></CardHeader>
                <CardContent>
              ...
              <div className="bg-card border-border">
                <CardHeader><CardTitle className="flex items-center gap-2 text-sm"><Monitor className="h-4 w-4" />By Device</CardTitle></CardHeader>
                <CardContent>
              ...
              <div className="bg-card border-border">
                <CardHeader><CardTitle className="flex items-center gap-2 text-sm"><Globe className="h-4 w-4" />By Browser</CardTitle></CardHeader>
                <CardContent>
            ...
            {/* Country Breakdown */}
            <div className="bg-card border-border">
              <CardHeader><CardTitle className="flex items-center gap-2 text-sm"><MapPin className="h-4 w-4" />By Country</CardTitle></CardHeader>
              <CardContent>
            ...
            {/* Recent Visit Logs */}
            <div className="bg-card border-border">
              <CardHeader><CardTitle className="flex items-center gap-2"><Clock className="h-5 w-5" />Recent Visit Logs</CardTitle></CardHeader>
          ...
          <TabsContent value="seller-analytics" className="space-y-4">
            <div className="bg-card border-border">
              <CardHeader className="pb-3"><CardTitle className="flex items-center gap-2"><Store className="h-5 w-5" />Seller Analytics Overview</CardTitle></CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                  <div className="flex flex-col items-center gap-2 p-4 rounded-lg bg-muted/50 text-center">
            ...
            <div className="bg-card border-border">
              <CardHeader><CardTitle className="flex items-center gap-2"><TrendingUp className="h-5 w-5" />Seller Activity (Last {rangeLabel})</CardTitle></CardHeader>
              <CardContent>
            ...
            <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
              <div className="bg-card border-border">
                <CardHeader><CardTitle className="flex items-center gap-2 text-sm"><BarChart3 className="h-4 w-4" />By Event Type</CardTitle></CardHeader>
                <CardContent>{sellerEventTypes?.length === 0 ? <p className="text-muted-foreground text-center py-4 text-sm">No events yet</p> : <RevolutDonutChart data={sellerEventTypes || []} height={200} showLabels />}</CardContent>
              </div>
              <div className="bg-card border-border">
                <CardHeader><CardTitle className="flex items-center gap-2 text-sm"><Monitor className="h-4 w-4" />By Device</CardTitle></CardHeader>
                <CardContent>{sellerDeviceStats?.length === 0 ? <p className="text-muted-foreground text-center py-4 text-sm">No data yet</p> : <RevolutDonutChart data={sellerDeviceStats || []} height={200} showLabels />}</CardContent>
              </div>
            </div>

            <div className="bg-card border-border">
              <CardHeader><CardTitle className="flex items-center gap-2"><Store className="h-5 w-5" />Top Stores by Views</CardTitle></CardHeader>
              <CardContent>
          ...
          <TabsContent value="referrals" className="space-y-4">
            <div className="bg-card border-border">
              <CardHeader className="pb-3"><CardTitle className="flex items-center gap-2"><Link2 className="h-5 w-5" />Referral Analytics Overview</CardTitle></CardHeader>
              <CardContent>
                <div className="grid grid-cols-3 gap-3">
                  <div className="flex flex-col items-center gap-2 p-4 rounded-lg bg-muted/50 text-center">
                    <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-primary/10"><MousePointerClick className="h-5 w-5 text-primary" /></div>
            ...
            <div className="bg-card border-border">
              <CardHeader><CardTitle className="flex items-center gap-2"><TrendingUp className="h-5 w-5" />Referral Clicks (Last {rangeLabel})</CardTitle></CardHeader>
              <CardContent><RevolutAreaChart data={referralTrend || []} xKey="date" series={[{ dataKey: 'clicks', color: 'hsl(262 100% 71%)', name: 'Clicks' }]} height={250} /></CardContent>
            </div>

            <div className="bg-card border-border">
              <CardHeader><CardTitle className="flex items-center gap-2"><Users className="h-5 w-5" />Top Referrers</CardTitle></CardHeader>
              <CardContent>
            ...
            <div className="bg-card border-border">
              <CardHeader><CardTitle className="flex items-center gap-2"><Clock className="h-5 w-5" />Recent Referral Clicks</CardTitle></CardHeader>
              <CardContent className="p-0 sm:p-6">
                <div className="overflow-x-auto">
                  <div className="max-h-[400px] overflow-y-auto">
                    <Table>
