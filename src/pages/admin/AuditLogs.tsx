  ...
  return (
    <AdminLayout requiredRoles={['admin']}>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-display font-bold">Role Change Audit Logs</h1>
          <p className="text-muted-foreground">Track all role additions and removals</p>
        </div>
                ...
                filteredLogs?.map((log) => {
                  ...
                  return (
                    <TableRow key={log.id}>
                      ...
                      <TableCell>
                        <span className="text-sm">{details?.target_email || 'Unknown'}</span>
                      </TableCell>
                      <TableCell>
