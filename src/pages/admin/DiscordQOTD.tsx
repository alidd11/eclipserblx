...
const QUESTION_CATEGORIES = {
  gaming: {
    ...
    questions: [
      ...
      "What's the hardest boss fight you've ever beaten?",
      "What game do you think everyone should play at least once?",
      "What's a game you loved as a kid but forgot about?",
      "Which game world would you want to live in?",
      "What's the longest gaming session you've ever had?",
      "What's a game mechanic you wish more games had?",
      "If you could erase your memory of one game to replay it fresh, which would it be?",
      "What's the most toxic game you've ever played?",
      "What's the best free-to-play game out right now?",
  ...
  roleplay: {
    ...
    questions: [
      ...
      "What's the funniest thing that's happened to you in an RP?",
      "Do you prefer being a hero or villain in roleplay?",
      "What's your go-to RP character backstory?",
      "What roleplay game has the best customization?",
      "How long do you usually stay in character during RP?",
      "What's the most creative RP server you've ever joined?",
      "What's a roleplay rule you think every server should have?",
      "What's your opinion on permadeath in roleplay?",
      "What type of RP character do you find the most fun to play?",
      "Have you ever created your own RP server? How did it go?",
    ]
  },
  community: {
    label: 'Community',
    ...
    questions: [
      ...
      "If you could learn any language overnight, which would it be?",
  ...
  funHypothetical: {
    ...
    questions: [
      ...
      "If you had to eat one food for every meal forever, what would it be?",
      ...
      "If you could talk to one animal species, which would you pick?",
    ]
  },
  creative: {
    label: 'Creative',
    ...
    questions: [
      ...
      "If you could compose a song, what genre would it be?",
      "What's an art style you wish you could master?",
      "If you had to design a new game, what would it be about?",
      "What's the most creative gift you've ever given or received?",
      "If you could paint anything and have it hang in a museum, what would you paint?",
      "What's a creative project you started but never finished?",
      "If you could direct a movie, what would the plot be?",
  ...
  music: {
    ...
    questions: [
      ...
      "What's a guilty pleasure song you love?",
      "What show are you currently binge-watching?",
      "What's the best movie you've seen this year?",
      "If your life had a theme song, what would it be?",
      "What's the worst movie you've ever watched?",
      "Do you prefer movies, TV shows, or anime?",
      "What's a show everyone loves but you just can't get into?",
    ]
  },
  food: {
    ...
    questions: [
      ...
      "Sweet or savory — which do you prefer?",
      "What's a food from another country you'd love to try?",
    ]
  },
  wouldYouRather: {
    ...
    questions: [
      ...
      "Would you rather give up gaming or give up music?",
      "Would you rather live without your phone or without your PC?",
    ]
  }
};
