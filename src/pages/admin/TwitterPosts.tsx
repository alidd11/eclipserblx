      ...
      <div className={`min-h-screen w-full ${theme.bg} transition-colors duration-200`}>
        <div className="flex justify-center w-full">
          ...
          <div className={`w-full lg:max-w-[600px] ${theme.border} lg:border-x min-h-screen`}>
            {/* Top header */}
            <div className={`sticky top-0 z-20 backdrop-blur-xl ${theme.headerBg} ${theme.border} border-b`} style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif' }}>
              {/* Top row */}
