    ...
    <BotDashboardLayout>
      <div className="space-y-6 max-w-4xl">
        <div>
          ...
          <p className="text-sm text-white/50 mt-1">Send messages and embeds to Discord channels</p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr,320px]">
          ...
          <div className="rounded-xl bg-white/5 border border-white/10 p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <Label className="text-xs text-white/60">Server</Label>
            ...
            {useEmbed && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <Label className="text-xs text-white/60">Embed Title</Label>
                  <Input
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      className="w-12 h-9 p-1 cursor-pointer bg-white/5 border-white/10"
                    />
                    <Input
                      value={embedColor}
                      onChange={(e) => setEmbedColor(e.target.value)}
            ...
            <div>
              <Label className="text-xs text-white/60">{useEmbed ? 'Description' : 'Message'}</Label>
              <Textarea
          ...
          {useEmbed && (
            <div className="rounded-xl bg-white/5 border border-white/10 p-5">
              ...
              >
                ...
                <p className="text-sm text-white/70 whitespace-pre-wrap">{message || 'Your description here...'}</p>
