        ...
        <Tabs defaultValue="giveaways" className="space-y-4">
          ...
          <TabsContent value="giveaways" className="space-y-4">
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader><CardTitle className="text-white text-base">Create Giveaway</CardTitle></CardHeader>
            ...
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader><CardTitle className="text-white text-sm">Active Giveaways</CardTitle></CardHeader>
            ...
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-white text-base">Starboard</CardTitle>
          ...
          <TabsContent value="suggestions" className="space-y-4">
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader><CardTitle className="text-white text-base">Suggestion Settings</CardTitle></CardHeader>
              <CardContent className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader><CardTitle className="text-white text-sm">Recent Suggestions</CardTitle><CardDescription className="text-white/40">{suggestions.length} total</CardDescription></CardHeader>
              <CardContent className="p-0">
          ...
          <TabsContent value="verification">
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-white text-base">Verification Gate</CardTitle>
                  <Switch checked={vEnabled} onCheckedChange={setVEnabled} />
                </div>
                <CardDescription className="text-white/40">Require users to verify before accessing the server.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <TabsContent value="joingate">
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-white text-base">Join Gate Filters</CardTitle>
                  <Switch checked={jgEnabled} onCheckedChange={setJgEnabled} />
                </div>
                <CardDescription className="text-white/40">Filter new joins by account age, avatar, etc.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <TabsContent value="scheduled">
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader><CardTitle className="text-white text-base">Scheduled Messages</CardTitle></CardHeader>
              <CardContent className="p-0">
          ...
          <TabsContent value="autorole">
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader><CardTitle className="text-white text-base">Auto-Role on Join</CardTitle></CardHeader>
              <CardContent className="space-y-3">
          ...
          <TabsContent value="joinleave">
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader><CardTitle className="text-white text-base">Join/Leave Announcements</CardTitle></CardHeader>
          ...
          <TabsContent value="modlog">
            <Card className="bg-white/[0.03] border-white/10">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-white text-base">Mod Log Channel</CardTitle>
                  <Switch checked={mlEnabled} onCheckedChange={setMlEnabled} />
                </div>
                <CardDescription className="text-white/40">Log moderation actions to a Discord channel.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
