...
export default function GlobalGuardPermissions() {
 ...
 <h3 className="font-semibold text-sm text-xl font-medium flex items-center gap-2">
 ...
 <div className="border border-border rounded-xl overflow-hidden bg-card border-border">
 <div className="px-4 py-3 border-b border-border bg-muted/30">
 <h3 className="font-semibold text-sm text-lg font-medium flex items-center gap-2">
