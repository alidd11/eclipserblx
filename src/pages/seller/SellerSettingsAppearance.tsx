  ...
  useEffect(() => {
    if (store) {
      setFormData({
        ...
        font_heading: (store as any).font_heading || 'inter',
        font_body: (store as any).font_body || 'inter',
        layout_style: (store as any).layout_style || 'grid',
        hero_title: (store as any).hero_title || '',
        hero_subtitle: (store as any).hero_subtitle || '',
        hero_cta_text: (store as any).hero_cta_text || 'Browse Products',
        hero_cta_link: (store as any).hero_cta_link || '',
        announcement_text: (store as any).announcement_text || '',
        announcement_active: (store as any).announcement_active || false,
        show_reviews: (store as any).show_reviews !== false,
        show_social_proof: (store as any).show_social_proof !== false,
